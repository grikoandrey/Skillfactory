...
Итоговое задание 7.5 (HW-03) в рамках курса Fullstack разработчик на Python.
...
- !!! Дополнительно: отправка писем выведена в консоль
- !!! Срок еженедельной отправки установлен 1 минута, аргументы закомментированы
- !!! Отправка уведомления реализована 2 способами (через представления и через "сигналы"), сигналы закомментированы.
----------------------------------------------------------------------------------------------------------
Архив:
